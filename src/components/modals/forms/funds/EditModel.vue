        ...
        >
          ...
          <div class="modal-body py-10 px-lg-17">
            ...
            >
              ...
              <div class="fv-row mb-7">
                <!--begin::Label-->
                <label class="required fs-6 fw-semibold mb-2">commercial register</label>
                <!--end::Label-->
              ...
              <div class="fv-row mb-7">
                ...
                <!--begin::Input-->
                <el-form-item prop="fund_company_type">
                  <el-select
                    v-model="formData.fund_company_type"
                    filterable
                    placeholder="Select"
                    style="width: 240px"
                  >
                ...
                <!--end::Input-->
                <div v-if="errors">
                  <span v-if="errors.fund_company_type" class="error-from-server">{{
                    errors.fund_company_type
                  }}</span>
                </div>
              </div>
              <!--end::Input group-->
  ...
  setup(props) {
    ...
    const rules = ref({
      ...
      fund_company_type: [
        {
          required: true,
          message: "fund company type is required",
          trigger: "change",
        },
      ],
      commercial_register: [
    ...
    watch(
      ...
      ([newVal, val2, brandVal]) => {
        ...
        formData.value.fund_company_type = brandd.value.fund_company_type;
