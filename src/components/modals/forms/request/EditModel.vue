    ...
    <div class="modal-dialog modal-dialog-centered mw-650px">
      ...
      <div class="modal-content">
        ...
        <div class="modal-header d-flex align-items-center" id="kt_modal_add_customer_header">
          <!--begin::Modal title-->
          <h2 class="fw-bold m-0">edit a brand</h2>
          <!--end::Modal title-->
          ...
          <div class="modal-body py-10 px-lg-17">
            ...
            <div class="scroll-y me-n7 pe-7" id="kt_modal_add_brand_scroll" data-kt-scroll="true"
              ...
              <div class="fv-row mb-7">
                <!--begin::Label-->
                <label class="required fs-6 fw-semibold mb-2">first batch</label>
                <!--end::Label-->

                <!--begin::Input-->
                <el-form-item prop="first_batch">
                  <el-input v-model="formData.first_batch" type="number" placeholder="" />
                  <div v-if="errors">
              ...
              <div class="fv-row mb-7">
                ...
                <el-form-item prop="last_batch">
                  <el-input v-model="formData.last_batch" type="number" placeholder="" />
                  <div v-if="errors">
              ...
              <div class="fv-row mb-7">
                ...
                <el-form-item prop="support">
                  <el-input v-model="formData.support" type="number" placeholder="" />
                  <div v-if="errors">
              ...
              <div class="fv-row mb-7">
                ...
                <el-form-item prop="instalment_duration">
                  <el-input v-model="formData.instalment_duration" type="number" placeholder="" />
                  <div v-if="errors">
                    <span v-if="errors.instalment_duration" class="error-from-server">{{ errors.instalment_duration
                      }}</span>
                  </div>
                </el-form-item>
                <!--end::Input-->
              ...
              <div class="fv-row mb-7">
                ...
                <!--begin::Input-->
                <el-form-item prop="first_batch">
                  <el-input v-model="formData.insurance_percentage" type="number" placeholder="" />
                  <div v-if="errors">
                    <span v-if="errors.insurance_percentage" class="error-from-server">{{ errors.insurance_percentage
                      }}</span>
                  </div>
                </el-form-item>
                <!--end::Input-->
              ...
              <div class="fv-row mb-7">
                ...
                <el-form-item prop="client_id">
                  <el-select v-if="options1" v-model="formData.client_id" placeholder="Select" style="width: 100%">
              ...
              <div class="fv-row mb-7">
                ...
                <el-form-item prop="offer_id">
                  <el-select v-if="options2" v-model="formData.offer_id" placeholder="Select" style="width: 100%">
  ...
  setup(props) {
    ...
    watch(
      ...
      ([newVal, val2, brandVal]) => {
        ...
        formData.value.first_batch = brandd.value.first_batch;
        formData.value.last_batch = brandd.value.last_batch;
        formData.value.support = brandd.value.support;
        formData.value.instalment_duration = brandd.value.instalment_duration;
        formData.value.insurance_percentage = brandd.value.insurance_percentage;
        formData.value.client_id = brandd.value.client_id;
        formData.value.offer_id = brandd.value.offer_id;
