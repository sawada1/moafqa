    ...
    <div class="modal-dialog modal-dialog-centered mw-650px">
      ...
      <div class="modal-content">
        ...
        <div class="modal-header d-flex align-items-center" id="kt_modal_add_customer_header">
          <!--begin::Modal title-->
          <h2 class="fw-bold m-0">{{ $t('editclientscore') }}</h2>
          <!--end::Modal title-->
  ...
  setup(props) {
    ...
    watch(
      ...
      ([newVal, val2, brandVal]) => {
        ...
        formData.value.net_salary = brandd.value.net_salary;
        formData.value.monthly_obligations = brandd.value.monthly_obligations;
        formData.value.lapor_sector_id = brandd.value.lapor_sector_id;
        formData.value.client_id = brandd.value.client_id;
        formData.value.salary_bank_id = brandd.value.salary_bank_id;
        formData.value.mortgage_loan = brandd.value.mortgage_loan;
        formData.value.simah_issue = brandd.value.simah_issue;
        formData.value.active = brandd.value.active;
        formData.value.employment_date = brandd.value.employment_date;
