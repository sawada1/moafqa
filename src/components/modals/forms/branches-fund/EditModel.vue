    ...
    <div class="modal-dialog modal-dialog-centered mw-650px">
      ...
      <div class="modal-content">
        ...
        <div class="modal-header d-flex align-items-center" id="kt_modal_add_customer_header">
          <!--begin::Modal title-->
          <h2 class="fw-bold m-0">edit a client</h2>
          <!--end::Modal title-->
          ...
          <div class="modal-body py-10 px-lg-17">
            ...
            <div class="scroll-y me-n7 pe-7" id="kt_modal_add_brand_scroll" data-kt-scroll="true"
              ...
              <div class="mb-7">
                ...
                <!--end::Label-->
                <!-- class="d-none" :class="{'d-block': !activeMap}" -->
                <el-form-item prop="long">
                  <div style="width: 100%; height: 300px" id="map2-fund"></div>
                </el-form-item>
                <!--begin::Input-->
                <!--end::Input-->
              </div>
...
export default defineComponent({
  ...
  setup(props) {
    ...
    async function initMap() {
      ...
      const map = new google.maps.Map(document.getElementById("map2-fund"), {
        zoom: 4,
        center: { lat: arguments[0], lng: arguments[1] },
        mapId: "DEMO_MAP_ID",
      });
    ...
    watch(
      ...
      ([newVal, val2, brandVal]) => {
        ...
        clickedLat.value = brandd.value.lat;
        clickedLng.value = brandd.value.long;
        formData.value.name = brandd.value.name;
        formData.value.email = brandd.value.email;
        formData.value.mobile = brandd.value.mobile;
        formData.value.address = brandd.value.address;
        formData.value.district = brandd.value.district;
        formData.value.lat = brandd.value.lat;
        formData.value.long = brandd.value.long;
        id.value = brandd.value.id;
        initMap(brandd.value.lat, brandd.value.long);
      }
    );
