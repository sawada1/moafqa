    ...
    <div class="modal-dialog modal-dialog-centered mw-650px">
      ...
      <div class="modal-content">
        ...
        <div class="modal-header d-flex align-items-center" id="kt_modal_add_customer_header">
          <!--begin::Modal title-->
          <h2 class="fw-bold m-0">{{ $t('editsubmodel') }}</h2>
          <!--end::Modal title-->
          ...
          <div class="modal-body py-10 px-lg-17">
            ...
            <div class="scroll-y me-n7 pe-7" id="kt_modal_add_brand_scroll" data-kt-scroll="true"
              ...
              <div class="fv-row mb-7">
                <!--begin::Label-->
                <label class="required fs-6 fw-semibold mb-2">{{ $t('arabicName') }}</label>
                <!--end::Label-->

                <!--begin::Input-->
                <el-form-item prop="name_en">
                  <el-input v-model="formData.name_en" type="text" placeholder="" />
                  <div v-if="errors">
              ...
              <div class="fv-row mb-7">
                ...
                <el-form-item prop="name_ar">
                  <el-input v-model="formData.name_ar" type="text" placeholder="" />
                </el-form-item>
                <!--end::Input-->
                <div v-if="errors">
              ...
              <div class="fv-row mb-7">
                <!--begin::Label-->
                <label class="required fs-6 fw-semibold mb-2"> {{ $t('model') }} </label>
                <!--end::Label-->

                <!--begin::Input-->
                <el-form-item prop="model_id">
                  <el-select v-if="options" v-model="formData.model_id" filterable placeholder="Select"
                    style="width: 240px">
                    <el-option v-for="item in options" :key="item.id" :label="item.name_en" :value="item.id" />
                  </el-select>
                </el-form-item>
                <!--end::Input-->
                <div v-if="errors">
...
import { useSubModelsStore } from "@/stores/subModels";
...
export default defineComponent({
  ...
  props: ["func"],
  setup(props) {
    const store = useSubModelsStore();
    const store2 = useModelsStore();
    ...
    const rules = ref({
      ...
      name_ar: [
        ...
        {
          required: true,
          message: locale.value == 'en' ? "model is required" : ' النموذج مطلوب',
          trigger: "change",
        },
      ],
    });
