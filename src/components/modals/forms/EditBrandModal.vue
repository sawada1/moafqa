  ...
  >
    ...
    <div class="modal-dialog modal-dialog-centered mw-650px">
      ...
      <div class="modal-content">
        ...
        >
          <!--begin::Modal title-->
          <h2 class="fw-bold m-0">{{ $t('editbrand') }}</h2>
          <!--end::Modal title-->
        ...
        >
          ...
          <div class="modal-body py-10 px-lg-17">
            ...
            <div
              ...
              id="kt_modal_edit_brand_scroll"
              data-kt-scroll="true"
              data-kt-scroll-activate="{default: false, lg: true}"
              data-kt-scroll-max-height="auto"
              data-kt-scroll-dependencies="#kt_modal_edit_brand_header"
              data-kt-scroll-wrappers="#kt_modal_edit_brand_scroll"
  ...
  setup(props) {
    ...
    const submit = async () => {
      ...
      formRef.value.validate(async (valid: boolean) => {
        if (valid && File.value) {
          loading.value = true;
          // formData.value.logo = File.value[0] ? File.value[0].name : '';
          if (File.value[0].raw) {
            store.uploadEditFile(
              id.value,
              File.value,
              formData.value,
    ...
    watch(
      ...
      ([newVal, val2, brandVal]) => {
        ...
        File.value[0].name = brandd.value.logo;
        File.value[0].url = brandd.value.full_logo_path;
      }
    );
