  ...
  <div class="card">
    ...
    <div class="card-body pt-0">
      ...
      >
        ...
        <template v-slot:district="{ row: customer }">
          {{ customer.district }}
        </template>
        <template v-slot:fund_company="{ row: customer }">
          {{ customer.fund_company }}
        </template>
        <template v-slot:city="{ row: customer }">
          {{ customer.city }}
        </template>
...
import AddModal from "@/components/modals/forms/branches-fund/AddModel.vue";
import EditModal from "@/components/modals/forms/branches-fund/EditModel.vue";
...
export default defineComponent({
  ...
  setup() {
    const headerConfig = ref([
      ...
      {
        columnName: "fund company",
        columnLabel: "fund_company",
        sortEnabled: true,
      },
      {
        columnName: "city",
