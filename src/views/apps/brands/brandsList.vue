...
import EditBrandModal from "@/components/modals/forms/EditBrandModal.vue";
...
export default defineComponent({
  ...
  setup() {
    ...
    const headerConfig = ref([
      ...
      {
        columnName: locale.value == "en" ? "logo" : "شعار",
        columnLabel: "logo",
        sortEnabled: true,
      },
      // {
