  ...
  <div class="card">
    ...
    <div class="card-body pt-0">
      ...
      >
        ...
        <template v-slot:color="{ row: customer }">
          <div class="color-hex-container" :style="{backgroundColor: customer.hex_code}"></div>
...
import AddModal from "@/components/modals/forms/colors/AddModel.vue";
import EditModal from "@/components/modals/forms/colors/EditModel.vue";
...
export default defineComponent({
  ...
  setup() {
    ...
    const headerConfig = ref([
      {
        columnName: locale.value == "en" ? "english name" : "الاسم باللغه الانجليزية",
        columnLabel: "eName",
        sortEnabled: true,
      },
      {
        columnName: locale.value == "en" ? "arabic name" : "الاسم باللغه العربية",
        columnLabel: "aName",
        sortEnabled: true,
      },
      {
        columnName: locale.value == "en" ? "color" : "اللون",
        columnLabel: "color",
        sortEnabled: true,
      },
      {
