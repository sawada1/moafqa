  ...
  <div class="card">
    ...
    <div class="card-body pt-0">
      ...
      >
        ...
        <template v-slot:logo="{ row: customer }">
          <div class="badge badge-light">{{ customer.billing }}</div>
          <img
            class=""
            style="width: 40px"
            :src="customer.full_logo_path"
            alt=""
          />
        </template>
...
import AddModal from "@/components/modals/forms/submodels/AddModel.vue";
import EditModal from "@/components/modals/forms/submodels/EditModel.vue";
...
export default defineComponent({
  ...
  setup() {
    ...
    const headerConfig = ref([
      ...
      {
        columnName: locale.value == 'en' ? "arabic name" : "الاسم العربية",
        columnLabel: "aName",
        sortEnabled: true,
      },
      {
