...
import AddModal from "@/components/modals/forms/models/AddModel.vue";
import EditModal from "@/components/modals/forms/models/EditModel.vue";
...
export default defineComponent({
  ...
  setup() {
    ...
    const headerConfig = ref([
      ...
      {
        columnName: locale.value == 'en' ? "actions" : 'الاجراءات',
        columnLabel: "actions",
        sortEnabled: false,
        columnWidth: 135,
      },
