  ...
  <div class="card">
    ...
    <div class="card-body pt-0">
      ...
      >
        ...
        <template v-slot:birth_date="{ row: customer }">
          {{ customer.birth_date }}
        </template>
...
import AddModal from "@/components/modals/forms/clients/AddModel.vue";
import EditModal from "@/components/modals/forms/clients/EditModel.vue";
...
export default defineComponent({
  ...
  setup() {
    ...
    const headerConfig = ref([
      {
        columnName: locale.value == "en" ? "arabic name" : "الاسم بالعربية",
        columnLabel: "Aname",
        sortEnabled: true,
      },
      {
        columnName: locale.value == "en" ? "english name" : "الاسم بالانجليزية",
        columnLabel: "Ename",
        sortEnabled: true,
      },
      {
      ...
      {
        columnName: locale.value == "en" ? "birth date" : "تاريخ الميلاد",
        columnLabel: "birth_date",
        sortEnabled: true,
      },
      {
        columnName: locale.value == "en" ? "actions" : "أجراءات",
        columnLabel: "actions",
        sortEnabled: false,
        columnWidth: 135,
      },
