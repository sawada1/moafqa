        ...
        <div class="card-body pt-15">
          ...
          <div id="kt_customer_view_details" class="collapse show">
            <div class="py-5 fs-6">
              ...
              <!--begin::Badge-->
              <!--begin::Details item-->
              <div class="fw-bold mt-5">{{ $t('name') }}</div>
              ...
              <div class="fw-bold mt-5">{{ $t('fundcompanytype') }}</div>
              <div class="text-gray-600">{{ brand.fund_company_type }}</div>
              <div class="fw-bold mt-5">{{ $t('commercialregister') }}</div>
