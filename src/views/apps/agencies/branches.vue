  ...
  <div class="card">
    ...
    <div class="card-body pt-0">
      ...
      >
        ...
        <template v-slot:agency="{ row: customer }">
          {{ customer.agency }}
        </template>
...
import AddModal from "@/components/modals/forms/branches-agency/AddModel.vue";
import EditModal from "@/components/modals/forms/branches-agency/EditModel.vue";
