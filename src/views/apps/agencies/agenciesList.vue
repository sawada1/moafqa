...
import AddModal from "@/components/modals/forms/agency/AddModel.vue";
import EditModal from "@/components/modals/forms/agency/EditModel.vue";
...
export default defineComponent({
  ...
  setup() {
    const headerConfig = ref([
      ...
      {
        columnName: "commercial register",
        columnLabel: "commercial_register",
        sortEnabled: true,
      },
      {
        columnName: "fund company type",
